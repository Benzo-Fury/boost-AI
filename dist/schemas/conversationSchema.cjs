...
var conversationSchema_exports = {};
__export(conversationSchema_exports, {
  default: () => conversationSchema_default
});
module.exports = __toCommonJS(conversationSchema_exports);
